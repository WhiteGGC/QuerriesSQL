...
/*1*/
SELECT us.id as user_id, us.name as user_name, us.email, pj.id as proj_id, pj.name as proj_name, pj.description, pj.date
FROM users us, users_has_projects up, projects pj
...
/*3*/
SELECT us.name
FROM users_has_projects up RIGHT OUTER JOIN users us
